          ...
          <div class="tempatdestinasi">
            ...
            <div class="tempat">
              <?php
                ...
                $result_paket = mysqli_query($konek, $query_paket);
              ...
              ?>
                    <div class="perdestinasi" id="paketdestinasi">
                      ...
                      <a class="tombol" href="detailberanda/detailpaket.php?new_id_pakettour=<?php echo $row_paket['new_id_pakettour']; ?>">Detail</a>
                    </div>
              <?php
                  }
                }
