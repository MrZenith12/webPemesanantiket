...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="../css/styleuserpaket.css">
           ...
           <div class="tempat">
               ...
               ?>
                   <div class="perdestinasi">
                     ...
                     <a class="tombol" href="detail/detailpaket.php?new_id_pakettour=<?php echo $row['new_id_pakettour']; ?>">Detail</a>
                   </div>
               <?php
                   }
                 } else {
