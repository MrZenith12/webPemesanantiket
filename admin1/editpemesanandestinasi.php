...
// mengecek apakah di url ada nilai GET id
  if (isset($_GET['id_pesdes'])) {
    // ambil nilai id dari url dan disimpan dalam variabel $id
    $id_pesdes = ($_GET["id_pesdes"]);

    // menampilkan data dari database yang mempunyai id=$id
    $query = "SELECT * FROM tbl_pesandes WHERE id_pesdes='$id_pesdes'";
...
<form action="prosespemesanan/destinasi/prosesedit.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        <input type="hidden" name="id_pesdes" class="form-control" value="<?php echo $data['id_pesdes']; ?>">
    </div>
    <div class="form-group">
        <label>Nama</label>
    ...
    <div class="form-group">
        ...
        <input type="text" name="hargades" class="form-control" value="<?php echo $data['hargades']; ?>">
    </div>
    <div class="form-group">
