...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="css/stylewisata.css">
           ...
           <div class="tempat">
               ...
               ?>
                   <div class="perdestinasi">
                     ...
                     <a class="tombol" href="detailberanda/detaildestinasi.php?id_destinasi=<?php echo $row['id_destinasi']; ?>">Detail</a>
                   </div>
               <?php
                   }
                 } else {
