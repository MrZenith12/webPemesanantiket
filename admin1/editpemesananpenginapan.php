...
// mengecek apakah di url ada nilai GET id
  if (isset($_GET['id_pesnip'])) {
    // ambil nilai id dari url dan disimpan dalam variabel $id
    $id_pesnip = ($_GET["id_pesnip"]);

    // menampilkan data dari database yang mempunyai id=$id
    $query = "SELECT * FROM tbl_pespenginapan WHERE id_pesnip='$id_pesnip'";
...
<form action="prosespemesanan/penginapan/prosesedit.php" method="POST" enctype="multipart/form-data">
    <div class="form-group">
        <input type="hidden" name="id_pesnip" class="form-control" value="<?php echo $data['id_pesnip']; ?>">
    </div>
    <div class="form-group">
        <label>Nama</label>
    ...
    <div class="form-group">
        ...
        <input type="text" name="harganip" class="form-control" value="<?php echo $data['harganip']; ?>">
    </div>
    <div class="form-group">
