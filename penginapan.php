...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="css/stylepenginapan.css">
           ...
           <div class="tempat">
               ...
               ?>
                   <div class="perdestinasi">
                     ...
                     <a class="tombol" href="detailberanda/detailpenginapan.php?id_penginapan=<?php echo $row['id_penginapan']; ?>">Detail</a>
                   </div>
               <?php
                   }
                 } else {
