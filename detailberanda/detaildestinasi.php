...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="detailcss/styledes.css">
...
<body>
    <section class="header">
       ...
       <nav class="navbar">
        ...
        <a href="../login.php" class="tbl-biru"><i class="fa-solid fa-user" style="padding: 10px; "></i>Login</a>
...
<section class="home">
   <div class="kotak">
     ...
     // jalankan query untuk mengambil data destinasi berdasarkan id_destinasi
    $query = "SELECT * FROM tbl_destinasi
          JOIN tbl_penginapan ON tbl_destinasi.id_penginapan = tbl_penginapan.id_penginapan
      ...
      while(($row = mysqli_fetch_assoc($result)) && $count < 1)
   {
      $count++;
      ?>
      <h1>Wisata Destinasi <?php echo $row['nama_destinasi']; ?></h1>
      <div class="gambar">
   ...
   <div class="kotakdua">
      <div>
         ...
         <div class="detail">
            ...
            <p class="dessatu"><?php echo $row['deskripsi']; ?></p>
         </div>

         <div class="kotakempat">
            <h1><i class="fa-solid fa-memo-circle-info"></i>Info tambahan<br>Tersedia Juga Penginapan</h1>
            ...
            <p><?php echo $row['fasilitas_penginapan']; ?></p>
         </div>
      </div>
      ...
      <div class="pesan">
         <div class="isi1">
            <h1>Harga Wisata</h1>
            <div class="kotak1">
               <h3>Ketersediaan destinasi: <?php echo $row['sisa_destinasi']; ?></h3>
            ...
            <div class="kotak5">
                <a href="#" onclick="showLoginAlert()"><i class="fa-solid fa-boxes-packing" style="padding:5px;"></i> Pesan Sekarang</a>
            </div>

            <script>
            function showLoginAlert() {
                alert("Login terlebih dahulu untuk memesan!");
