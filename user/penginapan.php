...
<head>
   ...
   <link rel="stylesheet" type="text/css" href="../css/styleuserpenginapan.css">
...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide" style="background:url(../img/hotel1.jpg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(../img/gambar9.jpg) no-repeat">
            <div class="content">
               <span>Keindahan Wisata di Indonesia</span>
               <h3>MARI JELAJAHI BERSAMA-SAMA</h3>
            </div>
         ...
         <div class="swiper-slide slide" style="background:url(../img/gambar10.jpg) no-repeat">
            <div class="content">
               <span>Keindahan Wisata di Indonesia</span>
               <h3>MARI JELAJAHI BERSAMA-SAMA</h3>
            </div>
   ...
   <div class="cari">
        <form method="post">
           <div class="search-container">
             <input class="search" type="text" name="search" autocomplete="off" placeholder="Cari Penginapan">
           ...
           <div class="tempat">
                <?php
                 ...
                 if(isset($_POST['price_range'])){
                   ...
                   $query .= " WHERE harga_penginapan BETWEEN $min_price AND $max_price";
                 }
               ...
               ?>
                   <div class="perdestinasi">
                     ...
                     <div class="deskripsi">
                       <h2>Rp <?php echo number_format($row['harga_penginapan'],0,',','.'); ?></h2>
                       <p class="parasatu"><?php echo substr($row['deskripsi_penginapan'], 0, 30); ?></p>
                       <p class="paradua">Sisa Kamar yang tersedia: <?php echo $row['sisa_penginapan']; ?></p>
                     </div>
                     <a class="tombol" href="detail/detailpenginapan.php?id_penginapan=<?php echo $row['id_penginapan']; ?>">Detail</a>
                   </div>
               <?php
                   }
                 } else {
