<!-- user_orders.php -->
<?php
$koneksi2 = mysqli_connect("localhost", "root", "", "tripbuddy");
session_start();
...
$hasilname = mysqli_query($koneksi2,$name);
   ...
   <div class="pemesanan">
    ...
    <div class="pesanaja">
        <div class="kanan_pesan">
           <h1>Riwayat Pesanan Penginapan</h1>
          <?php 

              $query = "SELECT * FROM tbl_pespenginapan WHERE id_user=$id_user";
              $count = 0;
              $no=1;
              $result = mysqli_query($koneksi2, $query);
              if (!$result) {
                die('Query Error: ' . mysqli_error($koneksi2));
            }
                  ...
                  <div class="kotak1">
                      <div class="nomor">
                          <?php 
                            ...
                            $pilihgambar = "SELECT gambar_penginapan FROM tbl_penginapan WHERE nama_penginapan = '$nama'";
                            $hasilgambar = mysqli_query($koneksi2, $pilihgambar);
                            $gambar = mysqli_fetch_array($hasilgambar);
                            ?>
                            <img style="text-align: center; font-size: 60px; max-width: 200px" src="../admin1/gambar/<?php echo $gambar['gambar_penginapan']; ?>">
                      </div>
                      <div class="desk">
                              <p>Nama :<?php echo $row['nama']; ?></p>
                              <p>Email  : <?php echo $row['email']; ?></p>
                              <p>Alamat : <?php echo $row['alamat']; ?></p>
                              <p>Nama Paket : <?php echo $row['nama_penginapan']; ?></p>
                              ...
                              <form  action="proseshapuspemesanan/proseshapuspenginapan.php?id_pesnip=<?php echo $row['id_pesnip']; ?>" method="post">
          ...
          <div class="tempatdestinasi">
            ...
            <div class="tempat">
              ...
              // Establish database connection
                ...
                $result_penginapan = mysqli_query($koneksi, $query_penginapan);
              ...
              ?>
                    <div class="perdestinasi" id="penginapan">
                      ...
                      <a class="tombol" href="detail/detailpenginapan.php?id_penginapan=<?php echo $row_penginapan['id_penginapan']; ?>">Detail</a>
                    </div>
              <?php
                  }
                }
