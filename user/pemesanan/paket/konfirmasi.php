            ...
            <div class="kotak2">
                ...
                <div class="form">
                    <form method="post" action="prosespayment.php">
                          <input type="hidden" id="harga_paket" name="harga_paket" value="<?php echo $harga_paket; ?>" readonly>
                          <input type="hidden" id="namapaket" name="namapaket" value="<?php echo $namapaket; ?>" readonly>
                          ...
                          <a href="Payment.php?new_id_pakettour=<?php echo $row['new_id_pakettour']; ?>" class="tombol">Kembali</a>
